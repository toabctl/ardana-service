...
default_config = os.path.normpath(os.path.join(os.path.dirname(__file__), 'defaults.cfg'))
...
def get_flask_config():
    ...
    The keys are converted to upercase as required by flask.  Since SafeConfigParser returns all values as strings
    """
